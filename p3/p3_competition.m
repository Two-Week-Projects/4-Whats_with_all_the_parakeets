classdef p3_competition < handle
    %P3_COMPETITION Summary of this class goes here
    ...
    methods
        function self = p3_competition(park, food_source)
        ...
        function tick(self)
            ...
            elseif proportion_to_norm < 0.1
                ...
                self.population_density = max(0.05, self.population_density * proportion_to_norm / 0.1);
                self.leeching = true;
            end
